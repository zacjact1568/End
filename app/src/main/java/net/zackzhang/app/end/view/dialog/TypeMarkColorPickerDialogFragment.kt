...
import net.zackzhang.app.end.view.adapter.TypeMarkColorGridAdapter
...
class TypeMarkColorPickerDialogFragment : BaseDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(defaultColor: Int): TypeMarkColorPickerDialogFragment {
    ...
    var typeMarkColorPickedListener: ((typeMarkColor: TypeMarkColor) -> Boolean)? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleText = ResourceUtil.getString(R.string.title_dialog_fragment_type_mark_color_picker)
        ...
        neutralButtonText = ResourceUtil.getString(R.string.btn_custom)
        ...
        positiveButtonClickListener = { typeMarkColorPickedListener?.invoke(typeMarkColor) != false }
    }
